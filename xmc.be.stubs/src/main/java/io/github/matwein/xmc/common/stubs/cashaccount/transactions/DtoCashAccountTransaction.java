...
public class DtoCashAccountTransaction implements Serializable {
	...
	public DtoCashAccountTransaction(
			Long id, Long categoryId, String categoryName, byte[] icon,
			String usage, String description, LocalDate valutaDate, BigDecimal value, String reference, String referenceIban,
			String referenceBank, String creditorIdentifier, String mandate) {
		
		this.id = id;
		this.category = (categoryId != null ? new DtoCategory(categoryId, categoryName, icon) : null);
		this.usage = usage;
