...
import io.github.matwein.xmc.fe.stages.main.analysis.logic.*;
import io.github.matwein.xmc.fe.stages.main.analysis.mapper.DtoAssetSelectionTreeItemMapper;
...
public class AnalysisContentController {
	private final ITimeRangeService timeRangeService;
